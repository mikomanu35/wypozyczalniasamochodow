...
<html lang="en">
  ...
  <body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
      <div class="container">
        <img style="width:65px" src="imgs/tlo.jpg" >
        <a class="navbar-brand" >Wypożyczalnia</a>
        <?php
        session_start();
...
?>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a  style="text-align:center" class="nav-link" href="paneladmin.php">Lista samochodów</a>
            </li> 
        </ul>
        </div>
      </div>
...
if ($result->num_rows > 0) {
    echo "<table>";
    echo "<tr><th>ID</th><th>ID_Użytkownika</th><th>ID_Samochodu</th><th>Data wypożyczenia </th><th>Data zwrotu</th><th>Liczba dni</th><th>Kwota(PLN)</th></tr>";
