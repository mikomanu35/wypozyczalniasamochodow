      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a  style="text-align:center" class="nav-link" href="rejestracja.php">Zaloguj</a>
            </li> 
        </ul>
        </div>
      </div>
...
if ($result->num_rows > 0) {
  echo "<table>";
  echo "<tr><th>#</th><th>ID</th><th>Marka</th><th>Model</th><th>Rok Produkcji</th><th>Dostępność</th><th>Wartość</th><th>Cena za 1 dzień</th></tr>";
